...
??? task "`augur ancestral`: Ancestral Nucleotide Sequence Reconstruction"
    ...
    !!! techdetails "Augur `ancestral` Technical Details"        
        ...
        | Software Documentation | [augur ancestral on Nextstrain](https://docs.nextstrain.org/projects/augur/en/stable/usage/cli/ancestral.html)<br>[TreeTime ReadTheDocs](https://treetime.readthedocs.io/en/latest/) |
