...
| amrfinderplus_nuc | **cpu** | Int | CPUs requested for this task | 8 | Optional |
| amrfinderplus_nuc | **detailed_drug_class** | Boolean | | False | Optional |
| amrfinderplus_nuc | **disk_size** | Int | Disk size requested for this task | 100 | Optional |
| amrfinderplus_nuc | **docker** | String | Docker image to use for this task | "us-docker.pkg.dev/general-theiagen/staphb/ncbi-amrfinderplus:3.11.20-2023-09-26.1" | Optional |
...
| amrfinderplus_nuc | **memory** | Int | Memory requested for this task | 16 | Optional |
