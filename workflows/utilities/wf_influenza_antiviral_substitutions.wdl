...
# Identify AA changes for Influenza NA, PA, PB1 and PB2 segments, and associated antiviral mutations
  ...
  call flu_antiviral.serialization {
    input:
      ...
      flu_tamiflu_resistance_array = select_all([flu_antiviral_parser_h1_ha.tamiflu_aa_subs, flu_antiviral_parser_h3_ha.tamiflu_aa_subs, flu_antiviral_parser_n1_na.tamiflu_aa_subs, flu_antiviral_parser_n2_na.tamiflu_aa_subs, flu_antiviral_parser_pa.tamiflu_aa_subs, flu_antiviral_parser_pb1.tamiflu_aa_subs, flu_antiviral_parser_pb2.tamiflu_aa_subs]),
  ...
  output {
    ...
    String flu_tamiflu_resistance = serialization.flu_tamiflu_resistance
