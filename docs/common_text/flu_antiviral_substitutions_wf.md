...
??? task "`flu_antiviral_substitutions`: Antiviral Mutation Identification"
    This subworkflow determines if any antiviral mutations are present in the HA, NA, and MP segments of H1N1 or H3N2 flu samples, or any in non-subtype-specific PA, PB1, and PB2 segments.
