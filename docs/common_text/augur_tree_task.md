---
title: Task Fragment `augur_tree`
fragment: true
---
??? task "`augur tree`: Phylogenetic Tree Reconstruction"
    The `augur tree` command generates a phylogenetic tree using either IQ-Tree 2, FastTree, or RAxML. By default, the tree will be generated by IQ-TREE 2. FastTree can result in significant performance improvements at the cost of phylogenetic resolution if the alignment contains 100s of sequences and computational throughput is a priority. Additionally, the task defaults to using a GTR evolutionary model, which can be modified via the `substitution_model` input.
    ...
    !!! techdetails "Augur `tree` Technical Details"        
        ...
        | Software Source Code | [Augur on GitHub](https://github.com/nextstrain/augur)<br>[FastTree on GitHub](https://github.com/morgannprice/fasttree)<br>[IQ-TREE on GitHub](https://github.com/iqtree/iqtree2)<br>[RAxML on GitHub](https://github.com/stamatak/standard-RAxML) |
        | Software Documentation | [augur tree on Nexstrain](https://docs.nextstrain.org/projects/augur/en/stable/usage/cli/tree.html)<br>[FastTree Documentation](https://morgannprice.github.io/fasttree/)<br>[IQ-TREE on GitHub](https://iqtree.github.io/doc/)<br>[RAxML Documentation](https://cme.h-its.org/exelixis/web/software/raxml/) |
