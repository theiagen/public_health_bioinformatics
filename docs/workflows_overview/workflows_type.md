...
| [**Clair3_Variants**](../workflows/phylogenetic_construction/clair3_variants.md)| ONT Variant Caller | Any taxa | Sample-level | Yes | 2.3.0 | [Clair3_Variants_ONT_PHB](https://dockstore.org/workflows/github.com/theiagen/public_health_bioinformatics/Clair3_Variants_ONT_PHB:mb-clair3-variant-dev?tab=info) |
