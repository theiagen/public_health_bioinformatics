...
??? task "`ShigaPass`: _Shigella_/EIEC differentiation and serotyping"
    ...
    !!! warning "==ShigaPass works best with assemblies generated with SPAdes=="
        ShigaPass operates optimally using assemblies generated with SPAdes. Other assemblers, like SKESA (TheiaProk_Illumina's default), can lead to incorrect or incomplete results due to missing detection of critical genes like _ipaH_.
