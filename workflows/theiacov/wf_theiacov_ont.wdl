...
workflow theiacov_ont {
  ...
  output {
    ...
    Int? irma_ha_num_minor_variants = flu_track.flu_ha_num_minor_variants
    Int? irma_na_num_minor_variants = flu_track.flu_na_num_minor_variants
    Int? irma_pa_num_minor_variants = flu_track.flu_pa_num_minor_variants
    Int? irma_pb1_num_minor_variants = flu_track.flu_pb1_num_minor_variants
    Int? irma_pb2_num_minor_variants = flu_track.flu_pb2_num_minor_variants
    Int? irma_mp_num_minor_variants = flu_track.flu_mp_num_minor_variants
    Int? irma_np_num_minor_variants = flu_track.flu_np_num_minor_variants
    Int? irma_ns_num_minor_variants = flu_track.flu_ns_num_minor_variants
