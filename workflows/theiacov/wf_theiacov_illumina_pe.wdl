...
workflow theiacov_illumina_pe {
  ...
  if (raw_check_reads.read_screen == "PASS") {
    ...
    if (clean_check_reads.read_screen == "PASS") {
      ...
      String flu_pimodivir_resistance_aa_subs_out = if (flu_antiviral_parser_n1_na.pimodivir_aa_subs == "" && flu_antiviral_parser_n2_na.pimodivir_aa_subs == "" && flu_antiviral_parser_pa.pimodivir_aa_subs == "" && flu_antiviral_parser_pb1.pimodivir_aa_subs == "" && flu_antiviral_parser_pb2.pimodivir_aa_subs == "") then [] else select_all([flu_antiviral_parser_n1_na.pimodivir_aa_subs,flu_antiviral_parser_n2_na.pimodivir_aa_subs,flu_antiviral_parser_pa.pimodivir_aa_subs,flu_antiviral_parser_pb1.pimodivir_aa_subs,flu_antiviral_parser_pb2.pimodivir_aa_subs])
  ...
  output {
    ...
    String? flu_pimodivir_resistance_aa_subs = flu_pimodivir_resistance_aa_subs_out
