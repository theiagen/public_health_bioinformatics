...
!!! caption "Core Gene SNP Workflow Diagram"
    ...
    ![Workflow taking GFF3 genome annotation files through PIRATE pangenome analysis, then producing core gene alignments, SNP distance matrices, and phylogenetic trees via IQ-TREE and snp-dists.](../../assets/figures/Core_Gene_SNP.png){: onload="this.width/=2;this.onload=null;" }
    </div>
...
{{ include_md("common_text/iqtree2_task.md", indent=4) }}
