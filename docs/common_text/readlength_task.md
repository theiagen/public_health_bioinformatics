---
title: Task Fragment `readlength`
fragment: true
---
??? task "`readlength`: Average Read Length Calculation"
    ...
    |  | Links |
    | --- | --- |
    | Task | [task_readlength.wdl](https://github.com/theiagen/public_health_bioinformatics/blob/main/tasks/quality_control/basic_statistics/task_readlength.wdl) |
