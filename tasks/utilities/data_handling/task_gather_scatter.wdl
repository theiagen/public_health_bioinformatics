...
task gather_scatter {
  input {
    ...
    # fastq_scan outputs
    Array[Int?] fastq_scan_num_reads_binned1 = [0000000]
    Array[Int?] fastq_scan_num_reads_binned2 = [0000000]
    ...
    # quast outputs
    Array[Int?] quast_genome_length = [0000000]
    Array[Int?] quast_number_contigs = [0000000]
    Array[Int?] quast_n50 = [0000000]
    Array[Float?] quast_gc_percent = [0000000]
    # consensus qc outputs
    Array[Int?] number_N = [0000000]
    Array[Int?] number_ATCG = [0000000]
    Array[Int?] number_Degenerate = [0000000]
    Array[Int?] number_Total = [0000000]
    Array[Float?] percent_reference_coverage = [0000000]
    # pangolin outputs
  ...
  command <<<
    ...
    sed -i 's/0000000//g' ~{samplename}.results.tsv
  >>>
  output {
