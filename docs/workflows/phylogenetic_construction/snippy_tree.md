...
| cg_reorder_matrix | **cpu** | Int | CPUs to allocate to reorder matrix task | 2 | Optional |
| cg_reorder_matrix | **disk_size** | Int | Disk size to allocate to reorder matrix task | 100 | Optional |
| cg_reorder_matrix | **docker** | String | Docker image for reorder matrix task | us-docker.pkg.dev/general-theiagen/staphb/mykrobe:0.12.1 | Optional |
| cg_reorder_matrix | **memory** | Int | Memory to allocate to reorder matrix task | 2 | Optional |
| cg_snp_dists | **cpu** | Int | CPUs to allocate to SNP dists task | 1 | Optional |
| cg_snp_dists | **disk_size** | Int | Disk size to allocate to SNP dists task | 50 | Optional |
| cg_snp_dists | **memory** | Int | Memory to allocate to SNP dists task | 2 | Optional |
| concatenate_variants | **docker_image** | String | Docker image for concatenate variants task | us-docker.pkg.dev/general-theiagen/theiagen/utility:1.1 | Optional |
...
| shared_variants | **cpu** | Int | CPUs to allocate to shared variants task | 1 | Optional |
| shared_variants | **disk_size** | Int | Disk size to allocate to shared variants task | 100 | Optional |
| shared_variants | **docker** | String | Docker image for shared variants task | us-docker.pkg.dev/general-theiagen/theiagen/terra-tools:2023-03-16 | Optional |
| shared_variants | **memory** | Int | Memory to allocate to shared variants task | 8 | Optional |
...
| snippy_tree_wf | **gubbins_docker** | String | Gubbins docker image to use | us-docker.pkg.dev/general-theiagen/biocontainers/gubbins:3.3--py310pl5321h8472f5a_0 | Optional |
| snippy_tree_wf | **gubbins_memory** | Int | Memory to allocate to Gubbins | 32 | Optional |
| snippy_tree_wf | **gubbins_disk_size** | Int | Disk size to allocate to Gubbins | 100 | Optional |
...
| snippy_tree_wf | **iqtree2_cpu** | Int | CPUs to allocate to IQTree2 | 4 | Optional |
| snippy_tree_wf | **iqtree2_disk_size** | Int | Disk size to allocate to IQTree2 | 100 | Optional |
| snippy_tree_wf | **iqtree2_docker** | String | IQTree2 docker image to use | us-docker.pkg.dev/general-theiagen/staphb/iqtree2:2.1.2 | Optional |
| snippy_tree_wf | **iqtree2_memory** | Int | Memory to allocate to IQTree2 | 32 | Optional |
...
| snippy_tree_wf | **snippy_core_cpu** | Int | CPUs to allocate to Snippy | 8 | Optional |
| snippy_tree_wf | **snippy_core_disk_size** | Int | Disk size to allocate to Snippy | 100 | Optional |
| snippy_tree_wf | **snippy_core_docker** | String | Snippy docker image to use | us-docker.pkg.dev/general-theiagen/staphb/snippy:4.6.0 | Optional |
| snippy_tree_wf | **snippy_core_memory** | Int | Memory to allocate to Snippy | 16 | Optional |
| snippy_tree_wf | **snp_dists_docker** | String | SNP-dists docker image to use | us-docker.pkg.dev/general-theiagen/staphb/snp-dists:0.8.2 | Optional |
| snippy_tree_wf | **snp_sites_cpus** | Int | CPUs to allocate to SNP-sites | 1 | Optional |
| snippy_tree_wf | **snp_sites_disk_size** | Int | Disk size to allocate to SNP-sites | 100 | Optional |
| snippy_tree_wf | **snp_sites_docker** | String | SNP-sites docker image to use | us-docker.pkg.dev/general-theiagen/staphb/snp-sites:2.5.1 | Optional |
| snippy_tree_wf | **snp_sites_memory** | Int | Memory to allocate to Snippy SNP-sites | 4 | Optional |
...
| summarize_data | **cpu** | Int | CPUs to allocate to Summarize data | 8 | Optional |
| summarize_data | **disk_size** | Int | Disk size to allocate to Summarize data | 100 | Optional |
| summarize_data | **docker** | String | Docker image for summarize data task | us-docker.pkg.dev/general-theiagen/theiagen/terra-tools:2023-03-16 | Optional |
...
| summarize_data | **memory** | Int | Memory to allocate to summarize data task | 1 | Optional |
...
| wg_reorder_matrix | **cpu** | Int | CPUs to allocate to reorder matrix task | 2 | Optional |
| wg_reorder_matrix | **disk_size** | Int | Disk size to allocate to reorder matrix task | 100 | Optional |
| wg_reorder_matrix | **docker** | String | Docker image for reorder matrix task | us-docker.pkg.dev/general-theiagen/staphb/mykrobe:0.12.1 | Optional |
| wg_reorder_matrix | **memory** | Int | Memory to allocate to reorder matrix task | 2 | Optional |
| wg_snp_dists | **cpu** | Int | CPUs to allocate to SNP dists task | 1 | Optional |
| wg_snp_dists | **disk_size** | Int | Disk size to allocate to SNP dists task | 50 | Optional |
| wg_snp_dists | **memory** | Int | Memory to allocate to SNP dists task | 2 | Optional |
