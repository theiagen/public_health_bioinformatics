          ...
          call export_taxon_table_task.export_taxon_table {
            input:
              ...
              columns_to_export = {
                ...
                "contaminant_coverage_by_sequence": read_QC_trim.contaminant_sequence_coverage,
                "contaminant_depth_by_sequence": read_QC_trim.contaminant_sequence_depth,
                "contaminant_expected_coverage_by_sequence": read_QC_trim.contaminant_expected_sequence_coverage,
                "contaminant_expected_depth_by_sequence": read_QC_trim.contaminant_expected_sequence_depth,
                "contaminant_expected_reads_by_sequence": read_QC_trim.contaminant_expected_sequence_reads_mapped,
                ...
                "contaminant_reads_by_sequence": read_QC_trim.contaminant_sequence_reads_mapped,
                "contaminant_status": read_QC_trim.contaminant_status,
                "contaminant_unexpected_coverage_by_sequence": read_QC_trim.contaminant_unexpected_sequence_coverage,
                "contaminant_unexpected_depth_by_sequence": read_QC_trim.contaminant_unexpected_sequence_depth,
                "contaminant_unexpected_reads_by_sequence": read_QC_trim.contaminant_unexpected_sequence_reads_mapped,
                ...
                "pilon_version": digger_denovo.pilon_version,
                ...
                "read2_subsampled_raw": read_QC_trim.read2_subsampled_raw,
                "read2": select_first([concatenate_illumina_lanes.read2_concatenated, read2]),
                ...
                "tbprofiler_output_json": merlin_magic.tbprofiler_output_json,
