...
workflow theiacov_fasta_set {
  ...
  output {
    ...
    # Nextclade outputs
    File? nextclade_json = select_first([sarscov2_nextclade.nextclade_json, mpxv_nextclade.nextclade_json, rsv_a_nextclade.nextclade_json, rsv_b_nextclade.nextclade_json, flu_h1n1_ha_nextclade.nextclade_json, flu_h1n1_na_nextclade.nextclade_json, flu_h3n2_ha_nextclade.nextclade_json, flu_h3n2_na_nextclade.nextclade_json, flu_yam_ha_nextclade.nextclade_json, flu_vic_ha_nextclade.nextclade_json, flu_vic_na_nextclade.nextclade_json])
    File? auspice_json = select_first([sarscov2_nextclade.auspice_json, mpxv_nextclade.auspice_json, rsv_a_nextclade.auspice_json, rsv_b_nextclade.auspice_json, flu_h1n1_ha_nextclade.auspice_json, flu_h1n1_na_nextclade.auspice_json, flu_h3n2_ha_nextclade.auspice_json, flu_h3n2_na_nextclade.auspice_json, flu_yam_ha_nextclade.auspice_json, flu_vic_ha_nextclade.auspice_json, flu_vic_na_nextclade.auspice_json])
