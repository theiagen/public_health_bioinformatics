...
| snippy_gene_query | **cpu** | Int | Number of CPUs for gene query task | 8 | Optional  |
| snippy_gene_query | **disk_size** | Int | Disk size for gene query task | 100 | Optional  |
| snippy_gene_query | **docker** | String | Docker image for gene query task | us-docker.pkg.dev/general-theiagen/theiagen/terra-tools:2023-06-21 | Optional  |
| snippy_gene_query | **memory** | Int | Memory for gene query task | 32 | Optional  |
...
| snippy_variants_wf | **memory** | Int | Memory to use | 16 | Optional  |
