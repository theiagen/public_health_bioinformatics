...
| tbp_parser | **cpu** | Int | Number of CPUs to use with this task | 1 | Optional |
| tbp_parser | **disk_size** | Int | Disk size, in GB, to use with this task | 100 | Optional |
| tbp_parser | **docker** | String | Docker container to use with this task | us-docker.pkg.dev/general-theiagen/theiagen/tbp-parser:1.6.0 | Optional |
...
| tbp_parser | **memory** | Int | Memory, in GB, to use with this task | 4 | Optional |
...
| trimmomatic_pe | **disk_size** | Int | Disk size, in GB, to use with this task | 100 | Optional |
| trimmomatic_pe | **docker** | String | Docker container to use with this task | us-docker.pkg.dev/general-theiagen/staphb/trimmomatic:0.39 | Optional |
| trimmomatic_pe | **memory** | Int | Memory, in GB, to use with this task | 8 | Optional |
