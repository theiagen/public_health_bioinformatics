...
workflow organism_parameters {
  ...
  if (organism == "flu" || organism == "influenza" || organism == "Flu" || organism == "Influenza") {
    ...
    String flu_kraken_target_organism = "Orthomyxoviridae"
  ...
  output {
    ...
    # kraken options
    String kraken_target_organism = select_first([kraken_target_organism_input, sc2_kraken_target_organism, mpox_kraken_target_organism, wnv_kraken_target_organism, flu_kraken_target_organism, hiv_v1_target_organism, hiv_v2_target_organism, rsv_a_kraken_target_organism, rsv_b_kraken_target_organism, ""])
    # augur options
