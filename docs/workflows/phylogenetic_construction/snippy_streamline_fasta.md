...
| centroid | **cpu** | Int | CPUs to allocate to Centroid | 1 | Optional |
| centroid | **disk_size** | Int | Disk size to allocate to Centriod | 50 | Optional |
| centroid | **docker** | String | Centroid docker image to use | us-docker.pkg.dev/general-theiagen/theiagen/centroid:0.1.0 | Optional |
| centroid | **memory** | Int | Memory to use for Centroid | 4 | Optional |
| ncbi_datasets_download_genome_accession | **cpu** | Int | CPUs to allocate to NCBI datasets | 1 | Optional |
| ncbi_datasets_download_genome_accession | **disk_size** | Int | Disk size to allocate to NCBI datasets | 50 | Optional |
| ncbi_datasets_download_genome_accession | **docker** | String | NCBI datasets docker image to use | us-docker.pkg.dev/general-theiagen/staphb/ncbi-datasets:14.13.2 | Optional |
...
| ncbi_datasets_download_genome_accession | **memory** | Int | Memory to use for NCBI datasets | 4 | Optional |
| referenceseeker | **cpu** | Int | CPUs to allocate to ReferenceSeeker | 4 | Optional |
| referenceseeker | **disk_size** | Int | Disk size to allocate to ReferenceSeeker | 200 | Optional |
| referenceseeker | **docker** | String | ReferenceSeeker docker image to use | us-docker.pkg.dev/general-theiagen/biocontainers/referenceseeker:1.8.0--pyhdfd78af_0 | Optional |
| referenceseeker | **memory** | Int | Memory to use for ReferenceSeeker | 16 | Optional |
...
| snippy_tree_wf | **snp_sites_cpu** | Int | CPUs to allocate to SNP-sites | 1 | Optional |
...
| snippy_variants_wf | **cpu** | Int | Number of CPUs to use | 4 | Optional |
