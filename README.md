...
55,316 from his line count when updating this list. Sage Wright subsequently deleted that .txt database in a later commit, so also please subtract 55,316 from Sage Wright's line count as well.
