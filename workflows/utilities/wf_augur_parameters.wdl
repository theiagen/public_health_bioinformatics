...
workflow augur_parameters {
  ...
  if (organism == "MPXV" || organism == "mpox" || organism == "monkeypox" || organism == "Monkeypox virus" || organism == "Mpox" || organism == "10244") {
    ...
    # inherited from flu defaults - currently unused
  ...
  if (organism == "flu" || organism == "influenza" || organism == "Flu" || organism == "Influenza" || organism == "11320" || organism == "11309" || organism == "11308" || organism == "11520") {
    ...
    if (flu_segment == "NA") {
      ...
      if (flu_subtype == "Victoria") {
        ...
        String vic_na_reference_gbk = "gs://theiagen-public-resources-rp/reference_data/viral/flu/reference_vic_na.gb"
  ...
  output {
    ...
    # these options are never used in augur since we removed augur_frequencies. commenting them out so we may re-add them in the future
