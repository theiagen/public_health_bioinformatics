...
workflow organism_parameters {
  ...
  if (organism == "flu" || organism == "influenza" || organism == "Flu" || organism == "Influenza" || organism == "11320" || organism == "11309" || organism == "11308" || organism == "11520") {
    ...
    if (flu_segment == "HA") {
      if (flu_subtype == "H1N1") {
        ...
        String h1n1_ha_nextclade_ds_tag = "2026-04-14--11-55-23Z"
      ...
      if (flu_subtype == "H3N2") {
        ...
        String h3n2_ha_nextclade_ds_tag = "2026-04-14--11-55-23Z"
      ...
      if (flu_subtype == "Victoria") {
        ...
        String vic_ha_nextclade_ds_tag = "2026-04-14--11-55-23Z"
      ...
      if (flu_subtype == "Yamagata") {
        ...
        String yam_ha_nextclade_ds_tag = "2026-04-14--11-55-23Z"
    ...
    if (flu_segment == "NA") {
      if (flu_subtype == "H1N1") {
        ...
        String h1n1_na_nextclade_ds_tag = "2026-04-14--11-55-23Z"
      ...
      if (flu_subtype == "H3N2") {
        ...
        String h3n2_na_nextclade_ds_tag = "2026-04-14--11-55-23Z"
      ...
      if (flu_subtype == "Victoria") {
        ...
        String vic_na_nextclade_ds_tag = "2026-04-14--11-55-23Z"
  ...
  if (organism == "rsv_a" || organism == "rsv-a" || organism == "RSV-A" || organism == "RSV_A" || organism == "208893") {
    ...
    String rsv_a_nextclade_ds_tag = "2026-04-14--11-55-23Z"
  ...
  if (organism == "measles" || organism == "Measles" || organism == "mev" || organism == "MeV" || organism == "Morbillivirus" || organism == "morbillivirus" || organism == "11234") {
    ...
    String measles_nextclade_ds_tag = "2026-04-14--11-55-23Z"
  ...
  if (organism == "Dengue Virus" || organism == "Orthoflavivirus denguei" || organism == "12637" || organism == "3052464") {
  ...
  output {
    ...
    String standardized_organism = select_first([sc2_org_name, mpox_org_name, wnv_org_name, flu_org_name, rsv_a_org_name, rsv_b_org_name, hiv_org_name, measles_org_name, rabies_org_name, mumps_org_name, rubella_org_name, dengue_org_name, organism])
