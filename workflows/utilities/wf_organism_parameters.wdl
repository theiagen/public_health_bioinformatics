...
workflow organism_parameters {
  ...
  output {
    ...
    File augur_lat_longs_tsv = select_first([lat_longs_tsv, sc2_lat_longs_tsv, flu_lat_longs_tsv, mpox_lat_longs_tsv, rsv_a_lat_longs_tsv, rsv_b_lat_longs_tsv, "gs://theiagen-public-resources-rp/empty_files/minimal-lat-longs.tsv"])
