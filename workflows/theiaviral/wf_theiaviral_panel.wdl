      ...
      call export_taxon_table_task.export_taxon_table {
        input:
          ...
          columns_to_export = {
            ...
            "read_mapping_coverage_by_sequence": theiaviral_illumina_pe.read_mapping_coverage_by_sequence,
            "read_mapping_depth": theiaviral_illumina_pe.read_mapping_depth,
            "read_mapping_depth_by_sequence": theiaviral_illumina_pe.read_mapping_depth_by_sequence,
