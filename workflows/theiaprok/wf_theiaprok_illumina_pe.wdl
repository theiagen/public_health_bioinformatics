    ...
    if (select_first([clean_check_reads.read_screen, ""]) == "PASS" || skip_screen) {
      ...
      if (perform_characterization) {
        ...
        if (genome_annotation == "bakta") {
          if (bakta_db == "light") {
            File bakta_db_light = "gs://theiagen-public-resources-rp/reference_data/databases/bakta/bakta_db_light_2026-08-06.tar.gz"
          }
          if (bakta_db == "full") {
            File bakta_db_full = "gs://theiagen-public-resources-rp/reference_data/databases/bakta/bakta_db_full_2026-08-06.tar.gz"
          }
