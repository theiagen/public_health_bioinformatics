        ...
        if (defined(qc_check_table)) {
          call qc_check.qc_check_phb as qc_check_task {
            input:
              ...
              qc_check_criteria = {
                "num_reads_raw1": [read_QC_trim.fastq_scan_raw1, "float", ">=", "false"],
                "num_reads_raw2": [read_QC_trim.fastq_scan_raw2, "float", ">=", "false"],
                "num_reads_clean1": [read_QC_trim.fastq_scan_clean1, "float", ">=", "false"],
                "num_reads_clean2": [read_QC_trim.fastq_scan_clean2, "float", ">=", "false"],
                ...
                "r1_mean_readlength_raw": [cg_pipeline_raw.r1_mean_readlength, "float", ">=", "false"],
                "r2_mean_readlength_raw": [cg_pipeline_raw.r2_mean_readlength, "float", ">=", "false"],  
                "combined_mean_readlength_raw": [cg_pipeline_raw.combined_mean_readlength, "float", ">=", "false"],
                "r1_mean_q_clean": [cg_pipeline_clean.r1_mean_q, "float", ">=", "false"],
                "r2_mean_q_clean": [cg_pipeline_clean.r2_mean_q, "float", ">=", "false"],
                "combined_mean_q_clean": [cg_pipeline_clean.combined_mean_q, "float", ">=", "false"],
                "r1_mean_readlength_clean": [cg_pipeline_clean.r1_mean_readlength, "float", ">=", "false"],
                "r2_mean_readlength_clean": [cg_pipeline_clean.r2_mean_readlength, "float", ">=", "false"],  
                "combined_mean_readlength_clean": [cg_pipeline_clean.combined_mean_readlength, "float", ">=", "false"],    
                "est_coverage_raw": [cg_pipeline_raw.est_coverage, "float", ">=", "false"],
                "est_coverage_clean": [cg_pipeline_clean.est_coverage, "float", ">=", "false"],
                "midas_secondary_genus_abundance": [read_QC_trim.midas_secondary_genus_abundance, "float", ">=", "false"],
                "midas_secondary_genus_coverage": [read_QC_trim.midas_secondary_genus_coverage, "float", ">=", "false"],
                "assembly_length": [quast.genome_length, "float", ">=", "false"],
                "number_contigs": [quast.number_contigs, "float", ">=", "false"],
                "n50_value": [quast.n50_value, "float", ">=", "false"],
                "quast_gc_percent": [quast.gc_percent, "float", ">=", "false"],
                "busco_results": [busco.busco_results, "float", ">=", "true"],
                "ani_highest_percent": [ani.ani_highest_percent, "float", ">=", "false"],
                "ani_highest_percent_bases_aligned": [ani.ani_highest_percent_bases_aligned, "float", ">=", "false"]
              }
          }
        }
