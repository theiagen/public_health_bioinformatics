...
fragment: true
---
??? task "`cladetyper`: _C. auris_ Clade Determination"
<!-- if: cauris_cladetyper -->
    This task employs GAMBIT for taxonomic identification, comparing whole genome sequencing data against reference databases to accurately classify _Candidozyma auris_ isolates.
<!-- endif -->
