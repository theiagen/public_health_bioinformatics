...
| [**Reference_Genome_Consensus**](../workflows/standalone/reference_genome_consensus.md)| Reference-guided genome assembly, read trimming, alignment, coverage filtering, and consensus sequence generation from ONT basecalled FASTQ files | Viral | Sample-level | Yes | vX.X.X | [Reference_Genome_Consensus_PHB](https://dockstore.org/workflows/github.com/theiagen/public_health_bioinformatics/Reference_Genome_Consensus_PHB:main?tab=info) |
