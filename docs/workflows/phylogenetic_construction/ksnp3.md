...
| core_ksnp3_shared_snps_task | **disk_size** | Int | Amount of storage (in GB) to allocate to this task | 100 | Optional |
| core_reorder_matrix | **cpu** | Int | Amount of CPUs to allocate to this task | 2 | Optional |
| core_reorder_matrix | **disk_size** | Int | Amount of storage (in GB) to allocate to this task | 100 | Optional |
| core_reorder_matrix | **docker** | String | Docker image to use | us-docker.pkg.dev/general-theiagen/staphb/mykrobe:0.12.1 | Optional |
| core_reorder_matrix | **memory** | Int | Amount of memory/RAM (in GB) to allocate to this task | 2 | Optional |
| core_snp_dists | **cpu** | Int | Amount of CPUs to allocate to this task | 1 | Optional |
| core_snp_dists | **disk_size** | Int | Amount of storage (in GB) to allocate to this task | 50 | Optional |
| core_snp_dists | **docker** | String | Docker image to use | us-docker.pkg.dev/general-theiagen/staphb/snp-dists:0.8.2 | Optional |
| core_snp_dists | **memory** | Int | Amount of memory/RAM (in GB) to allocate to this task | 2 | Optional |
| ksnp3_task | **cpu** | Int | Amount of CPUs to allocate to this task | 4 | Optional |
| ksnp3_task | **disk_size** | Int | Amount of storage (in GB) to allocate to this task | 100 | Optional |
| ksnp3_task | **docker_image** | String | Docker image used for running kSNP3 | us-docker.pkg.dev/general-theiagen/staphb/ksnp3:3.1 | Optional |
...
| pan_reorder_matrix | **docker** | String | Docker image to use | 100 | Optional |
| pan_reorder_matrix | **memory** | Int | Amount of memory/RAM (in GB) to allocate to this task | us-docker.pkg.dev/general-theiagen/staphb/mykrobe:0.12.1 | Optional |
| pan_snp_dists | **cpu** | Int | Amount of CPUs to allocate to this task | 1 | Optional |
| pan_snp_dists | **disk_size** | Int | Amount of storage (in GB) to allocate to this task | 50 | Optional |
| pan_snp_dists | **docker** | String | Docker image to use | us-docker.pkg.dev/general-theiagen/staphb/snp-dists:0.8.2 | Optional |
| pan_snp_dists | **memory** | Int | Amount of memory/RAM (in GB) to allocate to this task | 2 | Optional |
