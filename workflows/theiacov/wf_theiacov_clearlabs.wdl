...
workflow theiacov_clearlabs {
  ...
  call kraken2.kraken2_standalone as kraken2_raw {
    input:
      samplename = samplename,
      read1 = read1,
  ...
  if (defined(qc_check_table)) {
    call qc_check.qc_check_phb as qc_check_task {
      input:
        ...
        # kraken2_sc2 = kraken2_raw.percent_sc2,
        # kraken2_target_organism = kraken2_raw.percent_target_organism,
        kraken2_human_dehosted = kraken2_dehosted.kraken2_percent_human,
        # kraken2_sc2_dehosted = kraken2_dehosted.percent_sc2,
        # kraken2_target_organism_dehosted = kraken2_dehosted.percent_target_organism,
  ...
  output {
    ...
    String kraken2_target_organism_dehosted = kraken2_dehosted.kraken2_percent_target_organism
    File kraken2_report_dehosted = kraken2_dehosted.kraken2_report
    String kraken2_database = kraken2_dehosted.kraken2_database
