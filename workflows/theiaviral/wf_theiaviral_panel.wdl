...
workflow theiaviral_panel {
  input {
    ...
    Boolean skip_export = false # for testing purposes
  }  
          ...
          call export_taxon_table_task.export_taxon_table {
            input:
              ...
              columns_to_export = {
                ...
                "skani_top_ref_coverage": theiaviral.skani_top_ref_coverage,
                "skani_database": theiaviral.skani_database,
                "skani_version": theiaviral.skani_version,
                "skani_docker": theiaviral.skani_docker,
                "skani_top_ani_fasta": select_first([theiaviral.skani_top_ani_fasta]),
                "bwa_version": theiaviral.bwa_version,
                "bwa_samtools_version": select_first([theiaviral.bwa_samtools_version]),
                ...
                "bwa_sorted_bai": select_first([theiaviral.bwa_aligned_bai]),
                ...
                "ivar_variant_version": select_first([theiaviral.ivar_variant_version]),
                ...
                "consensus_qc_assembly_length_unambiguous": select_first([theiaviral.consensus_qc_assembly_length_unambiguous]),
                ...
                "checkv_consensus_version": select_first([theiaviral.checkv_consensus_version]),
