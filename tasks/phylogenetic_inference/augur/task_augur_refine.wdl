...
task augur_refine {
  input {
    ...
    Int gen_per_year = 50 # number of generations per year (default: 50)
    Float? clock_rate # fixed clock rate
    Float? clock_std_dev # standard deviation of the fixed clock_rate estimate
    Boolean covariance = true # account for covariation when estimating rates and/or rerooting (default: true)
    ...
    String branch_length_inference = "auto" # branch length mode of treetime to use (auto, joint, marginal, input; default: auto)
