...
workflow flu_track {
  ...
  output {
    ...
    String? flu_ha_num_minor_variants = irma.seg_ha_num_minor_variants
    String? flu_na_num_minor_variants = irma.seg_na_num_minor_variants
    String? flu_pa_num_minor_variants = irma.seg_pa_num_minor_variants
    String? flu_pb1_num_minor_variants = irma.seg_pb1_num_minor_variants
    String? flu_pb2_num_minor_variants = irma.seg_pb2_num_minor_variants
    String? flu_mp_num_minor_variants = irma.seg_mp_num_minor_variants
    String? flu_np_num_minor_variants = irma.seg_np_num_minor_variants
    String? flu_ns_num_minor_variants = irma.seg_ns_num_minor_variants
