...
??? task "`augur export`: Exporting Auspice-formatted Phylogenetic Trees"
    ...
    !!! techdetails "Augur `export` Technical Details"
        ...
        | Software Source Code | [Augur on GitHub](https://github.com/nextstrain/augur)<br>[Auspice on GitHub](https://github.com/nextstrain/auspice) |
        | Software Documentation | [augur export on Nextstrain](https://docs.nextstrain.org/projects/augur/en/stable/usage/cli/export.html)<br>[Auspice on Nextstrain](https://docs.nextstrain.org/projects/auspice/en/stable/) |
